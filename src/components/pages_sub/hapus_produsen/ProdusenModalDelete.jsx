...
function ModalDelete(props) {
  ...
  const deleteUser = async (e) => {
    e.preventDefault();
    try {
      await axios.delete(apiurl+`backend_satudata_produsen/${id}`);
      //navigate("/");
      setShow(false);
      sweetsuccess();
  ...
  return (
    ...
    <>
        <Link onClick={handleShow} className="col-span-4 max-[640px]:col-span-3 tsize-100 font-semibold text-white-a flex-right p-1">
          <button 
