...
import UserModalDelete from "./Komponen_ModalDelete"
    ...
    <div className="bg-gray-100  h-95 w-100  overflow-auto z-5  max-[640px]:mt-10">
      ...
      <div className="col-span-6">
        <p className=" tsize-90 font-semibold text-gray-300 flex pt-2 mt-1 mx-3 mb-0">
          ...
          <NavLink to="/Data-Satuportal_list" className="text-link-sky mx-2 d-flex">
      ...
      <Row className='margin-t3  max-w-full'>
        <Col md={6} sm={12}>
            <Row className='p-2 mx-1 bg-white rad15 garis5 shaddow1'>
              <p className='text-white textsize9 text-center btn-grad-sky-4 p-2 rad15'>Satuportal_list Info</p>
              <Col md={12} sm={12}>
                {loading ? (
                    <Spinner />
                  ) : (
      ...
      enabled: false
              ...
              <Tab eventKey="aksi" title="Aksi">
                <div className='w-100 d-flex'>
                  ...
                  <Link to={ `/Data-Satuportal_list/Update/${komponen}` } className="col-span-4 max-[640px]:col-span-3 tsize-100 font-semibold text-white-a flex-right p-2">
                    <button 
