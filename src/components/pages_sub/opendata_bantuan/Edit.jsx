...
function IklanPengelolah() {
  ...
  const getDataById = async () => {
    const response = await api_url_satuadmin.get(`api/open-item/opendata-bantuan/detail/${id}`);
  ...
  const updateIklan = async (e) => {
    ...
    try {
      ...
      await api_url_satuadmin.patch(`api/open-item/opendata-bantuan/update/${idku}`, formData, {
        headers: {
  ...
  return (
    <div className="bg-gray-100  h-95    overflow-auto z-5 max-[640px]:mt-10">
      <NavSub  title="Open Data Bantuan" />
      <div className="col-span-6">
        <p className=" textsize10 font-semibold text-gray-300 flex pt-2 mt-1 mx-3 mb-0">
          ...
          <NavLink to="/Opendata/Bantuan" className="text-silver-a mx-2 d-flex">
            <MdDataset className="mt-1 textsize10" />Opendata Bantuan
          </NavLink> /
