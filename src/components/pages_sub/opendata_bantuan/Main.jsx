...
export default function Iklanlist() {
  ...
  const getIklanSearch = async () => {
    const res = await api_url_satuadmin.get(`api/open-item/opendata-bantuan/admin`);
    ...
    
    {
      ...
      renderCell: (params) => (
        <div className="gap-2 p-2">
          <Link to={`/Opendata/Bantuan/Update/${params.row.title}`}>
        ...
        <div className="col-span-3">
          <p className="font-semibold text-gray-300 flex pt-2 mt-2 mx-3 mb-0">
            ...
            <NavLink to="#" className="textsize10 text-silver-a mx-2 flex">
              <MdDataset className="mt-1" /> Opendata Bantuan
            </NavLink>
          </p>
        </div>
