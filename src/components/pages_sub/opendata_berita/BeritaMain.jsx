...
export default function Iklanlist() {
  ...
  const getIklanSearch = async () => {
    const res = await api_url_satuadmin.get("api/opendata/artikel_admin");
    ...
    },
    {
      ...
      renderCell: (params) => (
        <div className="gap-2 p-2">
          <Link to={`/Opendata/Artikel/Update/${params.row.id_artikel}`}>
        ...
        <div className="col-span-3">
          <p className="font-semibold text-gray-300 flex pt-2 mt-2 mx-3 mb-0">
            ...
            <NavLink to="#" className="textsize11 text-silver-a mx-2 flex">
              <MdDataset className="mt-1" /> Opendata Artikel
            </NavLink>
          </p>
        </div>
