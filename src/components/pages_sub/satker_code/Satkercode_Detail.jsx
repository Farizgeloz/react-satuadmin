...
import UserModalDelete from "./SatkercodeModalDelete"
      ...
      <Row className='margin-t3  max-w-full'>
        <Col md={6} sm={12}>
            <Row className='p-2 mx-1 bg-white rad15 garis5 shaddow1'>
              <p className='text-white textsize9 text-center btn-grad-sky-4 p-2 rad15'>Satkercode Info</p>
              <Col md={12} sm={12}>
                {loading ? (
                    <Spinner />
                  ) : (
      ...
      enabled: false
              ...
              <Tab eventKey="aksi" title="Aksi">
                <div className='w-100 d-flex'>
                  ...
                  <Link to={ `/Data-Satkercode/Update/${komponen}` } className="col-span-4 max-[640px]:col-span-3 tsize-100 font-semibold text-white-a flex-right p-2">
                    <button 
