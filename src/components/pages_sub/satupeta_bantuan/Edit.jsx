...
function IklanPengelolah() {
  ...
  const getDataById = async () => {
    const response = await api_url_satuadmin.get(`openitem/satupeta-bantuan/detail/${id}`);
  ...
  const updateIklan = async (e) => {
    ...
    try {
      ...
      await api_url_satuadmin.patch(`openitem/satupeta-bantuan/update/${idku}`, formData, {
        headers: {
