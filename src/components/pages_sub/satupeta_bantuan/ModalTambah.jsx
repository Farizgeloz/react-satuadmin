...
function ModalTambahUser() {
  ...
  const saveIklan = async (e) => {
    ...
    formData.append("komponen","Tambah Bantuan Satu Peta");
    ...
    try {
      ...
      await api_url_satuadmin.post('api/open-item/satupeta-bantuan/add', formData);
    ...
    <>
        ...
        >
            ...
            <Modal.Header closeButton className="border-b ">
                <h4 className="text-sky-600 flex"><MdAddCircle  className="textsize10 text-sky-600 mt-1"  />Tambah Satupeta Bantuan</h4>
