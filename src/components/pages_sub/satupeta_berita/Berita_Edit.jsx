...
import { MdDashboard,MdDataset,MdEditSquare,
        ...
        MdOutlineSave,
        MdErrorOutline,
        MdOutlineErrorOutline} from "react-icons/md";
...
function IklanPengelolah() {
  ...
  const getDataById = async () => {
    ...
    const response = await api_url_satuadmin.get(`satupeta/map_artikel/detail_admin/${id}`);
  ...
  const updateIklan = async (e) => {
    ...
    try {
      ...
      await api_url_satuadmin.patch(`satupeta/map_artikel/update/${idku}`, formData, {
        headers: {
