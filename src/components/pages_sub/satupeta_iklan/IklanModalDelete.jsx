...
function ModalDelete(props) {
  ...
  const deleteUser = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        title: "Mohon Tunggu",
        html: "Sedang memproses delete data...",
      ...
      const payload = {
        ...
        jenis: "Satu Peta Iklan",
        komponen: "Delete Iklan Satu Peta"
      };

      await api_url_satuadmin.delete(`api/open-item/satupeta-iklan/delete/${id}`, {
