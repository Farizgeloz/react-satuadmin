...
function Tabel_Kec_Jk() {
  ...
  return (
    <div className="md:col-span-6 col-span-6 p-2  mb-20">
        ...
        <table className="max-[640px]:table-fixed border-collapse border-slate-400 w-full max-[640px]:w-full ">
          <thead>
            <tr className=" bg-blue-50 text-white w-full">
              ...
              <th className="tsize-80 border-2 border-white bg-gray-700 text-white px-2 tracking-wide wp-4">Jenis Kelamin</th>
          ...
          <tbody>
            {pendudukku.map((penduduk,index) => (
              <tr key={index} className=" even:bg-blue-50 odd:bg-white border-b-1 w-full">
                ...
                <td className="tsize-80 border-slate-300  p-2 tracking-wide wp-4">{penduduk.jk}</td>
                <td className="tsize-80 border-slate-300  p-2 tracking-wide wp-2 text-center">{penduduk.count_jk}</td>
